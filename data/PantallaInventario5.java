...
public class PantallaInventario5 {

	JFrame frmPantallaInventario5;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaInventario5 window = new PantallaInventario5();
					window.frmPantallaInventario5.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	public PantallaInventario5() {
		initialize();
		actualizarTabla();
		}
		 public void actualizarTabla() {
	     	DataInventario5 da = new DataInventario5();
	     	while(model.getRowCount()>0) {
	     		model.removeRow(0);
	     	}
		    lista=da.selectInventarios();
		     for (Inventario5 a : lista) {
		...
		private void initialize() {
			frmPantallaInventario5 = new JFrame();
			frmPantallaInventario5.getContentPane().setBackground(new Color(238, 232, 170));
			frmPantallaInventario5.setBounds(100, 100, 800, 592);
			frmPantallaInventario5.setLocationRelativeTo(null);
			frmPantallaInventario5.getContentPane().setLayout(null);
			frmPantallaInventario5.setExtendedState(JFrame.MAXIMIZED_BOTH);

			JScrollPane scrollPane = new JScrollPane();
			scrollPane.setBounds(10, 226, 1372, 663);
			frmPantallaInventario5.getContentPane().add(scrollPane);
			...
			frmPantallaInventario5.getContentPane().add(txtID);
			txtID.setColumns(10);
			...
			frmPantallaInventario5.getContentPane().add(txtModelo);
			...
			frmPantallaInventario5.getContentPane().add(txtDiseñador);
			...
			frmPantallaInventario5.getContentPane().add(txtPrecio);
			...
			frmPantallaInventario5.getContentPane().add(txtFecha);
			...
			frmPantallaInventario5.getContentPane().add(btnInsertar);
			...
			frmPantallaInventario5.getContentPane().add(btnActualizar);
			...
			frmPantallaInventario5.getContentPane().add(btnEliminar);
			
			JLabel lblNewLabel_6 = new JLabel("Inventario De Paraguas");
			lblNewLabel_6.setFont(new java.awt.Font("Tahoma", Font.BOLD, 35));
			lblNewLabel_6.setBounds(658, 19, 424, 79);
			frmPantallaInventario5.getContentPane().add(lblNewLabel_6);
			...
			frmPantallaInventario5.getContentPane().add(btnPDF);
		}
		public void limpiar() {
			txtID.setText("");
			txtModelo.setText("");
		...
		public void generarPDF() {
	        try {
	               ...
	               //RUTA ABSOLUTA
	               File file = new File("C:\\Users\\karla\\eclipse-workspace\\Aña\\src\\PDF\\Paraguas.pdf");
	               //RUTA RELATIVA
...
//	               Image img = Image.getInstance(getClass().getResource("/imagenes/logooxxo.png"));
	               ...
	               p.add(Chunk.NEWLINE);
	               p.add("CONTROL DE INVENTARIO DE PARAGUAS");
	               p.add(Chunk.NEWLINE);
	               p.add(Chunk.NEWLINE);
	               ...
	               PdfPCell c1 = new PdfPCell(new Phrase("ID PARAGUAS", negrita));
	               ...
	               DataInventario5 dc=new DataInventario5();
	               listaInventario=dc.selectInventarios();
	               for (Inventario5 c : listaInventario) {
	               ...
	               p1.add("NÚMERO DE PARAGUAS: " + listaInventario.size());
	               p1.add(Chunk.NEWLINE);
	               p1.add(Chunk.NEWLINE);
	               ...
	               JOptionPane.showMessageDialog(frmPantallaInventario5, "" + ex.getMessage());
