...
public class PantallaInventario2 {

	 JFrame frmPantallaInventario2;
	...
	ArrayList<Inventario2>listaInventario=new ArrayList<Inventario2>();
	Inventario2 x=null;
	ArrayList<Inventario2> lista;
	int fila=0;
	int id=0;
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaInventario2 window = new PantallaInventario2();
					window.frmPantallaInventario2.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	public PantallaInventario2() {
		initialize();
		actualizarTabla();
		}
		 public void actualizarTabla() {
	     	DataInventario2 da = new DataInventario2();
	     	while(model.getRowCount()>0) {
	     		model.removeRow(0);
	     	}
		    lista=da.selectInventarios();
		     for (Inventario2 a : lista) {
		...
		private void initialize() {
			frmPantallaInventario2 = new JFrame();
			frmPantallaInventario2.getContentPane().setBackground(new Color(238, 232, 170));
			frmPantallaInventario2.setBounds(100, 100, 800, 592);
			frmPantallaInventario2.setLocationRelativeTo(null);
			frmPantallaInventario2.getContentPane().setLayout(null);
			frmPantallaInventario2.setExtendedState(JFrame.MAXIMIZED_BOTH);

			JScrollPane scrollPane = new JScrollPane();
			scrollPane.setBounds(10, 226, 1372, 663);
			frmPantallaInventario2.getContentPane().add(scrollPane);
			...
			frmPantallaInventario2.getContentPane().add(txtID);
			txtID.setColumns(10);
			...
			frmPantallaInventario2.getContentPane().add(txtModelo);
			...
			frmPantallaInventario2.getContentPane().add(txtDiseñador);
			...
			frmPantallaInventario2.getContentPane().add(txtPrecio);
			...
			frmPantallaInventario2.getContentPane().add(txtFecha);
			...
			frmPantallaInventario2.getContentPane().add(btnInsertar);
			...
			frmPantallaInventario2.getContentPane().add(btnActualizar);
			...
			frmPantallaInventario2.getContentPane().add(btnEliminar);
			
			JLabel lblNewLabel_6 = new JLabel("Inventario De Vestidos");
			lblNewLabel_6.setFont(new java.awt.Font("Tahoma", Font.BOLD, 35));
			lblNewLabel_6.setBounds(662, 20, 424, 79);
			frmPantallaInventario2.getContentPane().add(lblNewLabel_6);
			...
			frmPantallaInventario2.getContentPane().add(btnPDF);
		}
		...
		public void generarPDF() {
	        try {
	               ...
	               //RUTA ABSOLUTA
	               File file = new File("C:\\Users\\karla\\eclipse-workspace\\Aña\\src\\PDF\\Vestidos.pdf");
	               //RUTA RELATIVA
...
//	               Image img = Image.getInstance(getClass().getResource("/imagenes/logooxxo.png"));
	               ...
	               p.add(Chunk.NEWLINE);
	               p.add("CONTROL DE INVENTARIO DE VESTIDOS");
	               p.add(Chunk.NEWLINE);
	               p.add(Chunk.NEWLINE);
	               ...
	               PdfPCell c1 = new PdfPCell(new Phrase("ID VESTIDO", negrita));
	               ...
	               DataInventario2 dc=new DataInventario2();
	               listaInventario=dc.selectInventarios();
	               for (Inventario2 c : listaInventario) {
	               ...
	               p1.add("NÚMERO DE VESTIDOS: " + listaInventario.size());
	               p1.add(Chunk.NEWLINE);
	               p1.add(Chunk.NEWLINE);
	               ...
	               JOptionPane.showMessageDialog(frmPantallaInventario2, "" + ex.getMessage());
