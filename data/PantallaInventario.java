...
public class PantallaInventario {
	...
	int fila=0;
	int id=0;
	ArrayList<Inventario>listaClientes=new ArrayList<Inventario>();
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaInventario window = new PantallaInventario();
					window.frmPantallaInventario.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public PantallaInventario() {
	 ...
	 public void actualizarTabla() {
     	DataInventario da = new DataInventario();
	...
	private void initialize() {
		frmPantallaInventario = new JFrame();
		frmPantallaInventario.getContentPane().setBackground(new Color(238, 232, 170));
		frmPantallaInventario.setBounds(100, 100, 800, 592);
		frmPantallaInventario.setLocationRelativeTo(null);
		frmPantallaInventario.getContentPane().setLayout(null);
		frmPantallaInventario.setExtendedState(JFrame.MAXIMIZED_BOTH);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 226, 1372, 663);
		frmPantallaInventario.getContentPane().add(scrollPane);
		...
		frmPantallaInventario.getContentPane().add(txtID);
		txtID.setColumns(10);
		...
		frmPantallaInventario.getContentPane().add(txtModelo);
		...
		frmPantallaInventario.getContentPane().add(txtDiseñador);
		...
		frmPantallaInventario.getContentPane().add(txtPrecio);
		...
		frmPantallaInventario.getContentPane().add(txtFecha);
		...
		frmPantallaInventario.getContentPane().add(btnInsertar);
		...
		frmPantallaInventario.getContentPane().add(btnActualizar);
		...
		frmPantallaInventario.getContentPane().add(btnEliminar);
		
		
		JLabel lblNewLabel_6 = new JLabel("Inventario De Sacos");
		lblNewLabel_6.setFont(new java.awt.Font("Tahoma", Font.BOLD, 35));
		lblNewLabel_6.setBounds(681, 28, 424, 79);
		frmPantallaInventario.getContentPane().add(lblNewLabel_6);
		...
		frmPantallaInventario.getContentPane().add(btnPDF);
	...
	public void generarPDF() {
        try {
               ...
               //RUTA ABSOLUTA
               File file = new File("C:\\Users\\karla\\eclipse-workspace\\Aña\\src\\PDF\\Sacos.pdf");
               //RUTA RELATIVA
...
//               Image img = Image.getInstance(getClass().getResource("/imagenes/logooxxo.png"));
               ...
               PdfPCell c1 = new PdfPCell(new Phrase("ID SACO", negrita));
               ...
               DataInventario dc=new DataInventario();
               listaInventario=dc.selectInventarios();
               for (Inventario c : listaInventario) {
               ...
               p1.add("NÚMERO DE SACOS: " + listaInventario.size());
               p1.add(Chunk.NEWLINE);
               p1.add(Chunk.NEWLINE);
               ...
               JOptionPane.showMessageDialog(frmPantallaInventario, "" + ex.getMessage());
