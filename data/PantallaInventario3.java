...
public class PantallaInventario3 {

	JFrame frmPantallaInventario3;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PantallaInventario3 window = new PantallaInventario3();
					window.frmPantallaInventario3.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	public PantallaInventario3() {
		initialize();
		actualizarTabla();
	}
	 public void actualizarTabla() {
     	DataInventario3 da = new DataInventario3();
     	while(model.getRowCount()>0) {
     		model.removeRow(0);
     	}
	    lista=da.selectInventarios();
	     for (Inventario3 a : lista) {
	...
	private void initialize() {
		frmPantallaInventario3 = new JFrame();
		frmPantallaInventario3.getContentPane().setBackground(new Color(238, 232, 170));
		frmPantallaInventario3.setBounds(100, 100, 800, 592);
		frmPantallaInventario3.setLocationRelativeTo(null);
		frmPantallaInventario3.getContentPane().setLayout(null);
		frmPantallaInventario3.setExtendedState(JFrame.MAXIMIZED_BOTH);

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 226, 1372, 663);
		frmPantallaInventario3.getContentPane().add(scrollPane);
		...
		frmPantallaInventario3.getContentPane().add(txtID);
		txtID.setColumns(10);
		...
		frmPantallaInventario3.getContentPane().add(txtModelo);
		...
		frmPantallaInventario3.getContentPane().add(txtDiseñador);
		...
		frmPantallaInventario3.getContentPane().add(txtPrecio);
		...
		frmPantallaInventario3.getContentPane().add(txtFecha);
		...
		frmPantallaInventario3.getContentPane().add(btnInsertar);
		...
		frmPantallaInventario3.getContentPane().add(btnActualizar);
		...
		frmPantallaInventario3.getContentPane().add(btnEliminar);
		
		JLabel lblNewLabel_6 = new JLabel("Inventario De Conjuntos");
		lblNewLabel_6.setFont(new java.awt.Font("Tahoma", Font.BOLD, 35));
		lblNewLabel_6.setBounds(661, 20, 486, 79);
		frmPantallaInventario3.getContentPane().add(lblNewLabel_6);
		...
		frmPantallaInventario3.getContentPane().add(btnPDF);
	}
	public void limpiar() {
		txtID.setText("");
		txtModelo.setText("");
	...
	public void generarPDF() {
        try {
               ...
               //RUTA ABSOLUTA
               File file = new File("C:\\Users\\karla\\eclipse-workspace\\Aña\\src\\PDF\\Conjuntos.pdf");
               //RUTA RELATIVA
...
//               Image img = Image.getInstance(getClass().getResource("/imagenes/logooxxo.png"));
               ...
               p.add(Chunk.NEWLINE);
               p.add("CONTROL DE INVENTARIO DE CONJUNTOS");
               p.add(Chunk.NEWLINE);
               p.add(Chunk.NEWLINE);
               ...
               PdfPCell c1 = new PdfPCell(new Phrase("ID CONJUNTO", negrita));
               ...
               DataInventario3 dc=new DataInventario3();
               listaInventario=dc.selectInventarios();
               for (Inventario3 c : listaInventario) {
               ...
               p1.add("NÚMERO DE CONJUNTOS: " + listaInventario.size());
               p1.add(Chunk.NEWLINE);
               p1.add(Chunk.NEWLINE);
               ...
               JOptionPane.showMessageDialog(frmPantallaInventario3, "" + ex.getMessage());
